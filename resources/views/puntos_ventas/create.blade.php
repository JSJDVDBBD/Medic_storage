...
@section('content')
    <div class="container mx-auto px-4 py-6">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form action="{{ route('punto-venta.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="gap-6">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="direccion" id="presentacion" value="{{ old('direccion') }}"
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                required>
                            @error('presentacion')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="telefono" id="laboratorio" value="{{ old('telefono') }}"
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                required>
                            @error('laboratorio')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
