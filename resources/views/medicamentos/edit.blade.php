    ...
    <div class="container mx-auto px-4 py-6">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-xl font-semibold mb-6 flex items-center">
                <i class="fas fa-pills mr-2"></i> Editar Medicamento
            </h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $medicamento->nombre) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="descripcion" id="descripcion" rows="3"
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('descripcion', $medicamento->descripcion) }}</textarea>
                            @error('descripcion')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="presentacion" id="presentacion" value="{{ old('presentacion', $medicamento->presentacion) }}"
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                required>
                            @error('presentacion')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="laboratorio" id="laboratorio" value="{{ old('laboratorio', $medicamento->laboratorio) }}"
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                required>
                            @error('laboratorio')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    ...
                    <div>
                        <div class="mb-4">
                            <label for="imagen" class="block text-gray-700 font-medium mb-2">Imagen del
                                Medicamento</label>
                            <div class="flex items-center justify-center w-full">
                                <label
                                    class="flex flex-col w-full h-32 border-2 border-dashed rounded-lg hover:bg-gray-50 hover:border-blue-300 transition-all">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <input type="number" name="stock" id="stock" value="{{ old('stock', $medicamento->stock) }}"
                                    min="0"
                                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    required>
                                @error('stock')
                            ...
                            <div class="mb-4">
                                <label for="stock_minimo" class="block text-gray-700 font-medium mb-2">Stock Mínimo
                                    *</label>
                                <input type="number" name="stock_minimo" id="stock_minimo"
                                    value="{{ old('stock_minimo', $medicamento->stock_minimo) }}" min="0"
                                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    required>
                                @error('stock_minimo')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-4">
                                <label for="precio_compra" class="block text-gray-700 font-medium mb-2">Precio Compra
                                    *</label>
                                <input type="number" name="precio_compra" id="precio_compra"
                                    value="{{ old('precio_compra', $medicamento->precio_compra) }}" min="0" step="0.01"
                                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    required>
                                @error('precio_compra')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            ...
                            <div class="mb-4">
                                <label for="precio_venta" class="block text-gray-700 font-medium mb-2">Precio Venta
                                    *</label>
                                <input type="number" name="precio_venta" id="precio_venta"
                                    value="{{ old('precio_venta', $medicamento->precio_venta) }}" min="0" step="0.01"
                                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    required>
                                @error('precio_venta')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-4">
                                <label for="fecha_caducidad" class="block text-gray-700 font-medium mb-2">Fecha Caducidad
                                    *</label>
                                <input type="date" name="fecha_caducidad" id="fecha_caducidad"
                                    value="{{ old('fecha_caducidad', \Carbon\Carbon::parse($medicamento->fecha_caducidad)->format('Y-m-d')) }}"
                                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    required>
